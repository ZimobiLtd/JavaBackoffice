...
import Gaming.Processor.MostPlayedMatchesProcessor;
...
public class MostPlayedMatchesAPI extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try 
        {
            ...
            System.out.println("getGamingMostPlayedData===="+jb.toString());
            ...
            if(function.equals("getMostPlayed"))
            {
                ...
                responseobj=new MostPlayedMatchesProcessor().getMostPlayed(fromdate ,todate);
            }
