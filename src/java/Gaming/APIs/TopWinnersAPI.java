...
import Gaming.Processor.TopWinnersProcessor;
...
throws ServletException, IOException {
    ...
    try 
    {
        ...
        System.out.println("getTopWinnersData===="+jb.toString());
        ...
        if(function.equals("getTopWinners"))
        {
            ...
            responseobj=new TopWinnersProcessor().getTopWinners(fromdate ,todate);
        }
