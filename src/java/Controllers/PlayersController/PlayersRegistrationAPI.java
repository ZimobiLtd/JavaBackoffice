 ...
 * @author jac
 */
@WebServlet(urlPatterns = {"/players/registrations"})
public class PlayersRegistrationAPI extends HttpServlet {
    ...
    throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            System.out.println("getPlayerRegistrations==="+jb.toString());
    ...
    throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            System.out.println("filterPlayerRegistrations==="+jb.toString());
            jsonobj = new JSONObject(jb.toString());
            String searchKey=jsonobj.getString("search_key");
            maindata=jsonobj.getString("data");

            if(searchKey.equals("mobile"))
            {
                ...
                responseObj=new PlayersRegistrationImpl().filterPlayerRegistrationsByMobile(mobile_no);  
            }
            else if(searchKey.equals("date"))
            {
