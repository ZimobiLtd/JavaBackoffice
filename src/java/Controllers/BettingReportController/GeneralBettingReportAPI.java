 ...
 * @author jac
 */
@WebServlet(urlPatterns = {"/betting/general/report"})
public class GeneralBettingReportAPI extends HttpServlet {
    ...
    throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            System.out.println("filterGeneralBettingReport==="+jb.toString());
            jsonobj = new JSONObject(jb.toString());
            maindata=jsonobj.getString("data");
