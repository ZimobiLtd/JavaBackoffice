...
import Players.PlayersProcessor.PlayerMonitorProcessor;
 ...
 * @author jac
 */
@WebServlet(urlPatterns = {"/AccountsMonitor"})
public class PlayerMonitorAPI extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try 
        {
            ...
            if(function.equals("monitorAccounts"))
            {
                responseobj=new PlayerMonitorProcessor().monitorAccounts();
            }
