 ...
 * @author jac
 */
@WebServlet(urlPatterns = {"/FinanceDashboard"})
public class FinanceDashBoardAPI extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try 
        {
            ...
            System.out.println("getFinanceDashboardData==="+jb.toString());
            ...
            if(function.equals("getDashboardData"))
            {
                ...
                responseobj=new FinanceDashboardSummaryProcessor().getFinancialDashboardSummary(fromdate ,todate);
            }
