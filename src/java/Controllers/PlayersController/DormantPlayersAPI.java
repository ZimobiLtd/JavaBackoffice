 ...
 * @author jac
 */
@WebServlet(urlPatterns = {"/players/dormant"})
public class DormantPlayersAPI extends HttpServlet {
    ...
    throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            System.out.println("getDormantPlayers==="+jb.toString());
            ...
            responseObj=new DormantPlayersImpl().getDormantPlayer(fromdate ,todate);
        }
    ...
    throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            System.out.println("filterDormantPlayers==="+jb.toString());
            jsonobj = new JSONObject(jb.toString());
            maindata=jsonobj.getString("data");
