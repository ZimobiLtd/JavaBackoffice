...
import Gaming.Processor.ProfitLossProcessor;
...
public class GamingProfitLossAPI extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try 
        {
            ...
            System.out.println("getGamingProfitLostData===="+jb.toString());
            ...
            {
                responseobj=new ProfitLossProcessor().getProfitLost(sdf.format(new Date()));
            }

            if(function.equals("filterProfitLost"))
            {
                String date=maindata;
                responseobj=new ProfitLossProcessor().getProfitLost(date);
            }
