...
public class BclbAPI extends HttpServlet {
    ...
    resp.setHeader("Access-Control-Allow-Methods", "POST");
        ...
        try 
        {
            ...
            System.out.println("getBCLBReportData===="+jb.toString());
            ...
            if(function.equals("getBCLBReport"))
            {
                ...
                responseobj=new BCLBReportProcessor().getBCLBReport(fromdate,todate);
            }
            ...
            if(function.equals("filterBCLBReport"))
            {
                ...
                String from=data[0];
                String to=data[1];    
                responseobj=new BCLBReportProcessor().getBCLBReport(from,to);
            }
