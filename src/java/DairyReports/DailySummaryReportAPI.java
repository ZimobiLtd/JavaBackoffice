...
public class DailySummaryReportAPI extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try 
        {
            ...
            System.out.println("getDailyReportData===="+jb.toString());
            ...
            if(function.equals("getDailySummary"))
            {
                ...
                responseobj=new DairySummaryReportProcessor().getDailySummary(fromdate ,todate);
            }
            ...
            if(function.equals("filterDailySummary"))
            {
                ...
                String from=data[0];
                String to=data[1];  
                responseobj=new DairySummaryReportProcessor().getDailySummary(from,to);
            }
