...
public class JackpotAPI extends HttpServlet {
    ...
    throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            if(action.equals("jackpots"))
            {
                //String []respo=new Utility().getDatesRange(0);
                //String fromdate=respo[0];
                //String todate=respo[1];
                responseObj=new JackpotImpl().getJackports();
            }
            else if(action.equals("jackpot_games"))
            {
    ...
    throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            System.out.println("setJackpotWinners==="+jb.toString());
            jsonobj = new JSONObject(jb.toString());
            maindata=jsonobj.getString("data");
    ...
    throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            System.out.println("deleteJackpot==="+jb.toString());
            jsonobj = new JSONObject(jb.toString());
            maindata=jsonobj.getString("data");
