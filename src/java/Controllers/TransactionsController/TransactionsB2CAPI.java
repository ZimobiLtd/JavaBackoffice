...
import Implimentation.TransactionsImplimentation.TransactionsB2CImpl;
 ...
 * @author jac
 */
@WebServlet(urlPatterns = {"/transactions/b2c"})
public class TransactionsB2CAPI extends HttpServlet {
    ...
    throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            responseObj=new TransactionsB2CImpl().filterTransactionsB2C(from,to,mobile,mpesaCode);
        }
        catch (IOException | JSONException ex) 
        { 
            ex.getMessage();
